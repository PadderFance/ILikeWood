...
public final class WoodenTieredItemType extends AbstractWoodenTieredObjectType {
    ...
    public static final WoodenTieredItemType PICKAXE = new WoodenTieredItemType(Constants.PICKAXE, Constants.PICKAXE_PLURAL);
    public static final WoodenTieredItemType SHOVEL = new WoodenTieredItemType(Constants.SHOVEL, Constants.SHOVEL_PLURAL);
