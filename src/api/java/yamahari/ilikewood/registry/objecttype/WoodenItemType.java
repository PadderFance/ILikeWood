...
public final class WoodenItemType extends AbstractWoodenObjectType {
    ...
    public static final WoodenItemType FISHING_ROD = new WoodenItemType(Constants.FISHING_ROD, Constants.FISHING_ROD_PLURAL);
    public static final WoodenItemType ITEM_FRAME = new WoodenItemType(Constants.ITEM_FRAME, Constants.ITEM_FRAME_PLURAL);
    public static final WoodenItemType PAINTING = new WoodenItemType(Constants.PAINTING, Constants.PAINTING_PLURAL);
