    ...
    extends AbstractWoodenObjectType
{
    ...
    public static final WoodenBlockType PANELS_STAIRS = new WoodenBlockType(Constants.PANELS_STAIRS, Constants.PANELS_STAIRS_PLURAL);
    public static final WoodenBlockType PANELS_SLAB = new WoodenBlockType(Constants.PANELS_SLAB, Constants.PANELS_SLAB_PLURAL);
    public static final WoodenBlockType BARREL = new WoodenBlockType(Constants.BARREL, Constants.BARREL_PLURAL);
    public static final WoodenBlockType WHITE_BED = new WoodenBlockType(Constants.WHITE_BED, Constants.WHITE_BED_PLURAL);
    public static final WoodenBlockType ORANGE_BED = new WoodenBlockType(Constants.ORANGE_BED, Constants.ORANGE_BED_PLURAL);
    public static final WoodenBlockType MAGENTA_BED = new WoodenBlockType(Constants.MAGENTA_BED, Constants.MAGENTA_BED_PLURAL);
    public static final WoodenBlockType LIGHT_BLUE_BED = new WoodenBlockType(Constants.LIGHT_BLUE_BED, Constants.LIGHT_BLUE_BED_PLURAL);
    public static final WoodenBlockType YELLOW_BED = new WoodenBlockType(Constants.YELLOW_BED, Constants.YELLOW_BED_PLURAL);
    ...
    public static final WoodenBlockType LIGHT_GRAY_BED = new WoodenBlockType(Constants.LIGHT_GRAY_BED, Constants.LIGHT_GRAY_BED_PLURAL);
    public static final WoodenBlockType CYAN_BED = new WoodenBlockType(Constants.CYAN_BED, Constants.CYAN_BED_PLURAL);
    public static final WoodenBlockType PURPLE_BED = new WoodenBlockType(Constants.PURPLE_BED, Constants.PURPLE_BED_PLURAL);
    public static final WoodenBlockType BLUE_BED = new WoodenBlockType(Constants.BLUE_BED, Constants.BLUE_BED_PLURAL);
    public static final WoodenBlockType BROWN_BED = new WoodenBlockType(Constants.BROWN_BED, Constants.BROWN_BED_PLURAL);
    public static final WoodenBlockType GREEN_BED = new WoodenBlockType(Constants.GREEN_BED, Constants.GREEN_BED_PLURAL);
    public static final WoodenBlockType RED_BED = new WoodenBlockType(Constants.RED_BED, Constants.RED_BED_PLURAL);
    public static final WoodenBlockType BLACK_BED = new WoodenBlockType(Constants.BLACK_BED, Constants.BLACK_BED_PLURAL);
    public static final WoodenBlockType BOOKSHELF = new WoodenBlockType(Constants.BOOKSHELF, Constants.BOOKSHELF_PLURAL);
    public static final WoodenBlockType COMPOSTER = new WoodenBlockType(Constants.COMPOSTER, Constants.COMPOSTER_PLURAL);
    public static final WoodenBlockType CRAFTING_TABLE = new WoodenBlockType(Constants.CRAFTING_TABLE, Constants.CRAFTING_TABLE_PLURAL);
    ...
    public static final WoodenBlockType SCAFFOLDING = new WoodenBlockType(Constants.SCAFFOLDING, Constants.SCAFFOLDING_PLURAL);
    public static final WoodenBlockType SOUL_TORCH = new WoodenBlockType(Constants.SOUL_TORCH, Constants.SOUL_TORCH_PLURAL);
    public static final WoodenBlockType TORCH = new WoodenBlockType(Constants.TORCH, Constants.TORCH_PLURAL);
    public static final WoodenBlockType WALL_TORCH = new WoodenBlockType(Constants.WALL_TORCH, Constants.WALL_TORCH_PLURAL, false);
    public static final WoodenBlockType WALL_SOUL_TORCH = new WoodenBlockType(Constants.WALL_SOUL_TORCH, Constants.WALL_SOUL_TORCH_PLURAL, false);
    ...
    public static final WoodenBlockType STRIPPED_POST = new WoodenBlockType(Constants.STRIPPED_POST, Constants.STRIPPED_POST_PLURAL);
    ...
    public static final WoodenBlockType SINGLE_DRESSER = new WoodenBlockType(Constants.SINGLE_DRESSER, Constants.SINGLE_DRESSER_PLURAL);
    public static final WoodenBlockType CAMPFIRE = new WoodenBlockType(Constants.CAMPFIRE, Constants.CAMPFIRE_PLURAL);
    public static final WoodenBlockType SOUL_CAMPFIRE = new WoodenBlockType(Constants.SOUL_CAMPFIRE, Constants.SOUL_CAMPFIRE_PLURAL);
    public static final WoodenBlockType CRATE = new WoodenBlockType(Constants.CRATE, Constants.CRATE_PLURAL);
