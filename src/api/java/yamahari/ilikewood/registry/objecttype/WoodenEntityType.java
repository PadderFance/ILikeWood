...
{
    public static final WoodenEntityType ITEM_FRAME = new WoodenEntityType(Constants.ITEM_FRAME, Constants.ITEM_FRAME_PLURAL);
    public static final WoodenEntityType CHAIR = new WoodenEntityType(Constants.CHAIR, Constants.CHAIR_PLURAL, false);
    public static final WoodenEntityType PAINTING = new WoodenEntityType(Constants.PAINTING, Constants.PAINTING_PLURAL, false);
